...
<head>
    <title>Answers</title>
    <link rel="stylesheet" type="text/css" href="../assets/css/answers.css">
    ...
    <div class="cot">
        ...
        <?php if ($QuizType == 0): ?>
            <?php foreach ($questions_mcq as $question): ?>
                <h2 class="ques" style='display: inline'>
                    <?php echo $index ?>.
                </h2>
                <?php if (!empty($question['Question'])): ?>
                    <h2 class="ques" style='display: inline;'> <?php echo htmlspecialchars($question['Question']); ?></h2>
                <?php endif; ?>
