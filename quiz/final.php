...
<body oncontextmenu="return false;">
    ...
    <div class="celebration">
        <img class="props" src="../assets/imgs/sparkler.png" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/firework.png" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/fireworks.png" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/confetti.png" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/confetti.gif" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/fireworks2.gif" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/balloons.gif" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/fireworks (1).png" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/firecracker.png" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/craker.png" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/cookie.png" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/garlands.png" alt="Falling Prop"> 
        <img class="props" src="../assets/imgs/sparkler.png" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/firework.png" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/fireworks.png" alt="Falling Prop"> 
        <img class="props"  src="../assets/imgs/confetti.png" alt="Falling Prop"> 
