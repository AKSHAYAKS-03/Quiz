...
if (!$_SESSION['logged'] || $_SESSION['logged'] === '') {
    echo "<script>condole.log('reached here')</script>";
...
<body>
    <nav class='admin-nav'>
        <h2>Admin</h2>
        <ul>
            <li><a href="../quiz/Add_Quiz.php">Add New Quiz</a></li>
            ...
            <ul id="multipleChoicesMenu" style="display: none;background-color:#2c3e50">
                <li><a href="../question/Q_add.php">Add Question</a></li>
                <li><a href="../question/Q_Edit.php">Edit/Delete Question</a></li>
            </ul>
            <li><a href="#" onclick="toggleSubmenu('FillupMenu')">Fill Up</a></li>
            <ul id="FillupMenu" style="display: none;background-color:#2c3e50">
                <li><a href="../question/Fillup_Q_add.php">Add/Edit Question </a></li>
            </ul>
            <li><a href="#" onclick="redirectIframe('iframe1', '../quiz/Delete_Quiz.php')">Delete Quiz</a></li>
            <li><a href="../quiz/reset.php">Reset Options</a></li>
    ...
    <div class="content">
        ...
        <div class="header-right">
            <a href="../public/about.html" title="About">
    ...
    <script>
        ...
        document.getElementById('exportQuiz').addEventListener('click', function() {
            ...
            window.location.href = "../quiz/exportQuiz.php?quizId=" + quizId + "&Quiztype=" + quizType + "&name=" + quizName;
        });
        ...
        function DeleteAll() {
            if (confirm("Are you sure you want to delete all quizzes, this will delete all the informations?")) {
                ...
                xhr.open("POST", "../quiz/DeleteAll.php", true);
        ...
        function openModal() {
            ...
            if (activeQuizId) {
                ...
                fetch(`../quiz/UpdateQuizTime.php?quizId=${activeQuizId}`)
